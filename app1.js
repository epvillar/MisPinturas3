...
window.addEventListener("DOMContentLoaded", function() {
    let displayObras1 = obras1.map(function(item) {
...
console.log(displayObras1) // me da las obras individualmente, el siguiente paso 
...
displayObras1 = displayObras1.join("")
console.log(displayObras1) // un gran string con todas las obras

// es paso siguiente es add ese string a our data usando la propiedad innerHTML
sectionCenter.innerHTML = displayObras1
})